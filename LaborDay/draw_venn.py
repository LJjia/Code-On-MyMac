...
jizhi_select_name=jizhi_df[jizhi_df['status']=='DOWN']['logFC']


immunity_df=pd.read_csv('immunity.csv')
immunity_select_name=immunity_df[immunity_df['status']=='DOWN']['logFC']
...
print(out_matrix)
out_matrix.transpose().to_csv('set_csv.txt',sep='\t')
